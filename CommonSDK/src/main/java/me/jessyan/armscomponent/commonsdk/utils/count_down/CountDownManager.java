package me.jessyan.armscomponent.commonsdk.utils.count_down;
...
import me.jessyan.armscomponent.commonsdk.utils.ThreadUtils;
...
//                    wingerAdapter.getItemCount()>3) {
//                autoScrollTime = System.currentTimeMillis();
//                if (!isRyWingerTouch) {
//                    if (mCurrentPosition+1<wingerAdapter.getItemCount())
//                        ryWinging.smoothScrollToPosition(++mCurrentPosition);
//                }else {
//                    mCurrentPosition = 0;
//                    ryWinging.smoothScrollToPosition(mCurrentPosition);
//                }
