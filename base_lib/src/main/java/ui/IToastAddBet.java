...
public class IToastAddBet {
//    public static synchronized void init(Application context) {
//        //使用布局加载器，将编写的toast_layout布局加载进来
//        if (view == null) {
//            view = LayoutInflater.from(context).inflate(R.layout.toast_layout_add, null);
//        }
//        if(toast != null) {
//            toast.cancel();
//            toast = null;
...
//    }
    ...
    private static void show(int show_length, Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.toast_layout_add, null);
        if(toast != null) {
            toast.cancel();
            toast = null;
        }
